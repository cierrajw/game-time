...
//when players collide you can splice value in the trail or move the head of the piece back one on the x or y axis
  ...
  animate() {
    this.players.forEach( player => {
      ...
      // let playerTrail1 = this.player1Trail.concat(this.players[0]);
      // let playerTrail2 = this.player2Trail.concat(this.players[1]);
  ...
  handlePlayer(player) {
    ...
    if (player1.isCollidingWith(player2) ||  player2.isCollidingWith(player1) || player.isCollidingWithWall(canvas.width, canvas.height)){
