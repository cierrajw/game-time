...
let player1 = new Player(1, 300, 5, 5, 'red', 'black', 1, 0, 3, 0);
let player2 = new Player(795, 300, 5, 5, 'yellow', 'black', -1, 0, 3, 0);
...
module.exports = class Game {
  ...
  animate() {
    ...
    if (this.isLevelRunning) {
      this.trails.push(new Trail(player1.x, player1.y, player1.height, player1.width, player1.color, player1.borderColor));
      this.trails.push(new Trail(player2.x, player2.y, player2.height, player2.width, player2.color, player2.borderColor));

      this.handlePlayer(player1);
      this.handlePlayer(player2);
